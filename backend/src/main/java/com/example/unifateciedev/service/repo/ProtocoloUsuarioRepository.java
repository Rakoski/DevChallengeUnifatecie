...
public interface ProtocoloUsuarioRepository extends JpaRepository<ProtocoloUser, Integer> {
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO protocolo_usuario(usuario_id, curso_id, protocolo_typeid, protocolo_etapa, protocolo_setor, protocolo_status, protocolo_campo1, protocolo_docpath) " +
